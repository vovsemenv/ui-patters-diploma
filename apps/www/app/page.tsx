      ...
      <section className="text-gray-600 body-font">
        <div className="max-w-7xl mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
          <div className="lg:flex-grow md:w-1/2 md:ml-24 pt-6 flex flex-col md:items-start md:text-left mb-40 items-center text-center">
            ...
            <div className="flex justify-center">
              <a
                className="inline-flex items-center px-5 py-3 mt-2 font-medium text-white transition duration-500 ease-in-out transform  border rounded-lg bg-blue-700"
                href="/docs"
              >
        ...
        <div className="grr max-w-7xl pt-20 mx-auto text-center">
          ...
          <div className="container flex flex-col items-center justify-center mx-auto rounded-lg ">
            <div className="col-span-2 grid items-start gap-6 lg:col-span-1 grid-flow-col">
              <DemoContainer>
                <DemoCreateAccount />
              </DemoContainer>
              <DemoContainer>
